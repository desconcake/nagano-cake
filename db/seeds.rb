...
Staff.create(id:1, email: 'admin@admin', password: 111111)
Order.find_or_create_by(id:1, :customer_id => 1, :billing_amount => 10000, :postage => 800, :method_of_payment => true, :delivery_name =>'ぺん太郎', :shipping_address => "配送先住所", :postal_code => 1600000, :order_status => 'waiting')
Order.find_or_create_by(id:2, :customer_id => 1, :billing_amount => 10000, :postage => 800, :method_of_payment => false, :delivery_name =>'ぺん次郎', :shipping_address => "配送先住所", :postal_code => 1600000, :order_status => 'waiting')
Order.find_or_create_by(id:3, :customer_id => 2, :billing_amount => 10000, :postage => 800, :method_of_payment => true, :delivery_name =>'ぺん三郎', :shipping_address => "配送先住所", :postal_code => 1600000, :order_status => 'waiting')
Order.find_or_create_by(id:4, :customer_id => 2, :billing_amount => 10000, :postage => 800, :method_of_payment => true, :delivery_name =>'ぺん四郎', :shipping_address => "配送先住所", :postal_code => 1600000, :order_status => 'waiting')
Order.find_or_create_by(id:5, :customer_id => 3, :billing_amount => 10000, :postage => 800, :method_of_payment => true, :delivery_name =>'ぺん五郎', :shipping_address => "配送先住所", :postal_code => 1600000, :order_status => 'waiting')
Order.find_or_create_by(id:6, :customer_id => 3, :billing_amount => 10000, :postage => 800, :method_of_payment => true, :delivery_name =>'ぺん六郎', :shipping_address => "配送先住所", :postal_code => 1600000, :order_status => 'waiting')
